        ...
        <div className="row gaper align-items-center">
          ...
          <div className="col-12 col-lg-6">
            <div className="agency__content section__content">
              ...
              Masters of Digital Design, Experts in Every Aspect
              </h2>
              <div className="paragraph">
                <p>
                At Softway Designs, our mission is simple: to make your company proud of partnering with us. From day one, our expert team of digital marketers, content creators, logo designers, and web development specialists has been dedicated to driving the digital transformation of businesses.
                </p>
              </div>
              <div className="skill-wrap">
                ...
                <div className="skill-bar-single">
                  ...
                  <div className="skill-bar-wrapper" data-percent="99%">
                    <div className="skill-bar">
                      <div className="skill-bar-percent">
                        <span className="percent-value"></span>
                      </div>
