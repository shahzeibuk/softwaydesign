                    ...
                    <div className="row gaper align-items-center">
                      ...
                      <div className="col-12 col-lg-7 offset-lg-1 col-xxl-7 offset-xxl-1">
                        <div className="testimonial-s__content">
                          ...
                          <div className="content">
                            <h4>
                            This sports brand "Titan Sports" is phenomenal! Their gear is top-notch, providing unmatched comfort and durability whether Iam hitting the gym or the trail. I am impressed by their innovative designs that enhance performance and style. For athletes serious about quality and performance, this brand is a game-changer!
                            </h4>
                          </div>
                          <div className="content-cta">
                            <h5>James Carter</h5>
