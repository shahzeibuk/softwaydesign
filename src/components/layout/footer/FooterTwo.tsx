          ...
          <div className="col-12 col-lg-5 col-xl-4">
            <div className="footer-two__left">
              ...
              <div className="paragraph">
                <p>
                Softway Designs is a digital agency specializing in logo design, branding, and website design, helping businesses succeed online with custom solutions that enhance brand presence.
                </p>
              </div>
        ...
        <div className="container">
          <div className="row align-items-center gaper">
            <div className="col-12 col-xl-6">
              ...
              <p>
                      Copyright &copy;
                      <span id="copyYear">{currentYear}</span> cloudwaysdesign.com by{" "}
                      . All Rights Reserved
                    </p>
              </div>
            </div>
